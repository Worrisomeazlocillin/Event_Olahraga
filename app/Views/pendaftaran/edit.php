                        ...
                        <div class="col-md-8 offset-md-2">
                            <div class="card card-primary">
                                <div class="card-header">
                                    <h3 class="card-title">Form Pendaftaran Edit</h3>
                                </div>
                                <form action="<?= base_url('pendaftaran/update/' . $pendaftaran['id']) ?>" method="post">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <select class="form-control" id="id_event" name="id_event">
                                            <?php foreach ($events as $eventItem): ?>
                                                <option value="<?= $eventItem['id'] ?>" <?= $event['id'] == $eventItem['id'] ? 'selected' : '' ?>>
                                    ...
                                    <div class="card-footer">
                                        ...
                                        <a href="<?= site_url('event/peserta/' . $event['id']) ?>" class="btn btn-secondary">Batal</a>
                                    </div>
